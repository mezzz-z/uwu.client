...
const userReducer = (state, action) => {
    switch(action.type) {
        ...
        case REMOVE_FRIEND_REQUEST:
            return {
                ...state,
                friendRequests: state.friendRequests.filter(fr => fr.user_id !== action.payload)
            }
        ...
        case REMOVE_FRIEND:
            return {
                ...state,
                friends: [...state.friends, state.friends.filter(friend => friend.user_Id !== action.payload)]
            }
