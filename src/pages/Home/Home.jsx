		...
		<main id='home' className='container'>
			...
			<section className='sidebar'>
				...
				<article className='sidebar-components-container'>
					...
					{currentSidebarComponent === "rooms" && (
						<Rooms setShowCreateRoomModal={setShowCreateRoomModal} />
					)}
					{currentSidebarComponent === "friends" && (
						<Friends setShowAddUserToRoomModal={setShowAddUserToRoomModal} />
					)}
			...
			{currentRoom.room_id && socketState.submittedList.currentRoom ? (
				...
				<div className='no-room'>
					<span>Open room to start chatting</span>
				</div>
			)}
			...
			{showAddUserToRoomModal.showModal && (
				<ModalWrapper
					hideModalCallback={() =>
						setShowAddUserToRoomModal({ showModal: false, userId: "" })
					}
					hideModalOnCoverClick={true}
					transparentCover={true}
				>
